...
# from utils.speech_2_text import Speech2TextService
# from utils.text_2_speech import Text2SpeechService
...
#         # Use the actual test audio file from assets
#         with open("assets/test.mp3", "rb") as audio_file:
#             audio_data = audio_file.read()
#             mock_audio_data = io.BytesIO(audio_data)
...
#     @patch('services.speech_service.speech_recognition')
...
#     @patch('services.speech_service.gTTS')
...
#     def test_handle_api_error_custom_api_error(self):
#         # Test handling custom APIError
#         error = APIError("Custom error", status_code=422)
#         response = handle_api_error(error)
...
#         assert response_data["error"] == "Custom error"
#         assert response_data["success"] is False
